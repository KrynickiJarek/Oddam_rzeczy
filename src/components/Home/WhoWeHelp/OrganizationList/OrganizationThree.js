        ...
        <div className="list_container">
            <div className="element_container">
                <div className="header_container">
                    <h2 className="header_container-head">Organizacja “Lorem Ipsum 7"</h2>
            ...
            <div className="element_container">
                <div className="header_container">
                    <h2 className="header_container-head">Organizacja “Lorem Ipsum 8”</h2>
            ...
            <div className="element_container">
                <div className="header_container">
                    <h2 className="header_container-head">Organizacja “Lorem Ipsum 9"</h2>
